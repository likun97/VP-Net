...
%           Q2n_index:          Q2n index.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Q2n_index, SAM_index, ERGAS_index,RASE_index,UIQI_index,PNSR_index,SSIM_index,RMSE_index] = indexes_evaluation(I_F,I_GT,ratio,L,Q_blocks_size,flag_cut_bounds,dim_cut,th_values)
...
SSIM_index = ssim(I_GT,I_F);
RASE_index = RASE(I_GT,I_F);
UIQI_index = uqi(I_GT,I_F);
PNSR_index = PSNR(I_GT,I_F);
PNSR_index = PNSR_index.ave;
